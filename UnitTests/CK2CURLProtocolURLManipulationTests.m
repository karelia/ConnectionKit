...
- (void)testFileURL;
{
    NSURL *url = [CK2CURLBasedProtocol newRequestWithRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"ftp://example.com//test"]]
                                                 isDirectory:NO].URL;
    STAssertEqualObjects(url.absoluteString, @"ftp://example.com//test", nil);
    
    url = [CK2CURLBasedProtocol newRequestWithRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"ftp://example.com/%2Ftest"]]
                                          isDirectory:NO].URL;
    STAssertEqualObjects(url.absoluteString, @"ftp://example.com/%2Ftest", nil);
    
    url = [CK2CURLBasedProtocol newRequestWithRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"ftp://example.com/%2F/test"]]
                                          isDirectory:NO].URL;
...
- (void)testMakingFileIntoFolder;
{
    ...
    url = [CK2CURLBasedProtocol newRequestWithRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"ftp://example.com/%2F"]]
                                          isDirectory:YES].URL;
